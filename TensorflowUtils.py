...
def save_image(image, RESTORATION_SIZE, save_dir, name, mean=None):
    """
    ...
    restore_image = misc.imresize(image, [RESTORATION_SIZE, RESTORATION_SIZE], interp='nearest')
    misc.imsave(os.path.join(save_dir, name + ".png"), restore_image)
